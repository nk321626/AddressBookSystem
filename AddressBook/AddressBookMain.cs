...
namespace AddressBook
{
    public class AddressBookMain
    {
        ...
        public void AddContactDetails(string firstName, string lastName, string address, string city, string state, long PostalCode, long phoneNumber, string email)
        {
            Contact contactDetails = new Contact(firstName, lastName, address, city, state, PostalCode, phoneNumber, email);
